...
import { moodOptions } from './quizConfig';

type Props = NativeStackScreenProps<RootStackParamList, 'QuizMood'>;

export function QuizMoodScreen({ navigation, route }: Props) {
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={[styles.scroll, { paddingHorizontal: pageHorizontalPadding }]}> 
        <Text style={styles.heading}>Choose your dream bedroom vibe</Text>
        ...
        <Pressable
          ...
          disabled={!selected}
          onPress={() =>
            navigation.navigate('QuizBudget', {
              aesthetic_style: route.params.aesthetic_style,
              mood_feel: selected as string,
            })
          }
        >
